...
function Navbar() {
  ...
  <div className="text-center md:text-left">
    <a href="#" className="inline-block text-sm px-4 py-2 leading-none border rounded
      ...
      hover:bg-white mt-4 lg:mt-0 md:align-mi " onClick={() => window.open("https://drive.google.com/file/d/1Ss3ccL9yX9De-oYT_JGCiz4E38H_XcAG/view?usp=share_link", "_blank")}>Download-Resume</a>
  </div>
</div>
